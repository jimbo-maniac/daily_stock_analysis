...
1. **Insider / Major Shareholder Activity** — sell-downs (reduce holdings), pledges
2. **Earnings Warnings** — pre-loss, downward revisions (performancepre-loss, performancechangeface)
3. **Regulatory** — penalties, investigations, violations (regulatory penalty, file caseadjustquery)
4. **Industry Policy** — headwinds, sector crackdowns
5. **Lock-up Expirations** — large block unlocks within 30 days (unlock)

# -*- coding: utf-8 -*-
"""
data_provider/us_index_mapping.py unittesting
"""
import unittest
import sys
import os

# ensurecanimport data_provider module（directlyimportavoidloadingagainvolumeleveldependency）
...
class TestGetUsIndexYfSymbol(unittest.TestCase):
    ...
    def test_dji_mapping(self):
        ...
        self.assertEqual(name, 'Dow Jones Industrialindex')

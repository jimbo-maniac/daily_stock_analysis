...
class TestNormalizeStockCode(unittest.TestCase):
    ...
    def test_hk_suffix_normalized_to_canonical_prefix(self):
        """HK stock .HK suffixformatshouldreturnoneas HK+5 digit number。"""
    ...
    def test_hk_prefix_is_zero_padded(self):
        """HK prefixshortcountcharacterformatshouldsupplementto 5 digit，for convenienceaftercontinuecachewithdeduplicate。"""

...
class TestAnalyzeRequest:
    ...
    def test_analyze_request_with_new_fields(self):
        ...
        assert request.stock_name == "Kweichow Moutai"
...
class TestTaskQueue:
    ...
    def test_task_queue_accepts_new_fields(self):
        ...
        assert len(tasks) == 1
        assert tasks[0].stock_name == "Kweichow Moutai"
    ...
    def test_task_queue_batch_with_new_fields(self):
        ...
        assert len(tasks) == 2
        for task in tasks:
            assert task.stock_name == "batchstock"
...
class TestIntegration:
    ...
    def test_end_to_end_flow_with_autocomplete(self):
        ...
        assert task.stock_name == "Kweichow Moutai"

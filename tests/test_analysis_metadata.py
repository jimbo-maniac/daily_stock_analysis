...
class TestSelectionSourcePatternEdgeCases:
    ...
    def test_pattern_unicode(self):
        ...
        assert pattern.fullmatch("automaticcomplete") is None
        assert pattern.fullmatch("imageidentify") is None
...
class TestSelectionSourceDocumentation:
    ...
    def test_source_use_cases(self):
        ...
        use_cases = {
            ...
            "autocomplete": [
                "User inputs 'Maotai', selects 'Kweichow Moutai' from dropdown",

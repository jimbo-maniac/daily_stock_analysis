...
class TestAnalyzerGenerateText:
    ...
    def test_generate_text_returns_llm_response(self):
        ...
        with patch.object(analyzer, "_call_litellm", return_value="marketanalysis report") as mock_call:
            result = analyzer.generate_text("write areview", max_tokens=1024, temperature=0.5)
            assert result == "marketanalysis report"
...
class TestMarketAnalyzerBypassFix:
    def _make_market_analyzer_with_mock_generate_text(self, return_value="reviewreport"):
    ...
    def test_no_access_to_private_model_attribute(self):
        ...
        ma = self._make_market_analyzer_with_mock_generate_text("reviewresult")
